...
\begin{table}[htbp]
	...
	\begin{tabular}{| p{2cm} || p{2cm} | p{1,2cm} | p{2,5cm} | p{1,5cm} | p{1,2cm} | p{1,2cm} |} \hline
		...
		Modell\-ierungs\-token  & Proxy & lit. & X-Y-Position und Rotation, Öffnungsstatus & konfig. & temp. & abh. \\ \hline
		einbett\-bares Token & Identifier & transf. & Präsenz, Container & konfig. & temp. & unabh. \\ \hline
...
Die Kardinalität und die Quelle des Links wurden hier nicht gesondert betrachtet, die die Kardinalität immer 1:1 ist, also eine eindeutige Zuordnung zwischen realem Objekt und digitaler Repräsentation gegeben ist und die Quelle des Links immer das reale Objekt ist. Im Übrigen verzichten auch \citet{Koleva03} auf die Einordnung in diese beiden Kategorien, da sie generell nur geringen Unterscheidungswert haben.
