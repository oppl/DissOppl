...
\section{Lernprozesse und Tangible Interface} % (fold)
...
ReacTable \citep{Kaltenbrunner06}
...
\section{Tangible Interfaces zur Erstellung diagrammatischer Modelle} % (fold)
