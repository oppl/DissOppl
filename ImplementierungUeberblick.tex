...
\begin{description}
	...
	\item[Configurability of Transformations] Gibt an, ob die Assoziation zwischen physischem Objekt und digitaler Repräsentation vorgegeben oder konfigurierbar ist. Mögliche Ausprägungen sind \emph{konfigurierbar} und \emph{fixiert}.
...
\subsubsection{TAC (Token and Constraints)}
...
\begin{description}
	\item[Couple]
	\item[Relative Definition] description
	\item[Association] description
	\item[Computational Interpretation] description
	\item[Manipulation] description 
\end{description}
