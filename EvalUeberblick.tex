...
In Block 5 wird im Wesentlich der Evaluierungs-Blocks 3 (siehe Abschnitt \ref{sub:eval_3})  hinsichtlich der Aufgabenstellung erneut durchgeführt. Im Gegensatz zu Block 3, wo die grundlegende Eignung des Werkzeugs zum Concept Mapping im Mittelpunkt stand, wird in Block 5 eine vergleichende Studie durchgeführt, die die Eignung des Tabletop Interfaces zum kollaborativen Concept Mapping mit jener der rechner-basierten CMapTools (REF) vergleicht.

\subsubsection{Kontext} % (fold)
\label{ssub:5_kontext}

Identisch mit dem in Abschnitt \ref{ssub:3_kontext} beschriebenen Kontext.
