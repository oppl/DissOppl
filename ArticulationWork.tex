...
Neben der Unterscheidung zwischen impliziter und und den expliziter Articulation Work  anhand der Komplexität der zugrunde liegenden Interaktion und dem  führt Strauss keine weitere systematische Betrachtung von Articulation Work hinsichtlich deren Ausprägungen durch. Offensichtlich wird in seinen Texten jedoch, dass es Articulation Work als eindeutig also solche identifizierbares Phänomen nur bedingt gibt. Abhängig vom betrachteten Arbeitsablauf, der Arbeitsumgebung und den beteiligten Personen zeigt sich Articulation Work in unterschiedlichen Formen.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item working out arrangements vs. reworking arrangements
	\end{itemize}
...
Bezüglich der unterschiedlichen Arten von „Articulation Work“ sind im Wesentlichen zwei Gegensatzpaare -- „implizit vs. explizit“ und „situated vs. planned“ zu identifizieren, die orthogonal zueinander stehen (auch wenn die Hauptachse „implizit -- situated“ vs. „explizit -- planned“ ist). Die Unterscheidung zwischen „working out arrangements“ und „reworking arrangements“ geht, wie nach dem nächsten Abschnitt deutlich werden wird, in den Kombinationen der Ausprägungen der ersten beiden Gegensatzpaare auf.

„Situated Articulation Work“ tritt ungeplant während des Arbeitsablaufs auf und dient der ad-hoc- Abstimmung. Obwohl diese in den meisten Fällen implizit abläuft, sind doch Fälle vorstellbar, in denen eine explizite, d.h. bewusst durchgeführte, „Articulation Work“ sinnvoll bzw. notwendig ist (siehe weiter unten -- Gegenstand der „Articulation Work“). „Planned Articulation Work“ hingegen ist immer explizit, die Kombination von geplanter und implizit, d.h. unbewusst durchgeführter, „Articulation Work“ ist nicht sinnvoll.

„Working out arrangements“ und „reworking arrangements“ sind Spezialfälle von expliziter „Articulation Work“, die sich im Wesentlichen in der Ausgangsposition der Aushandlung unterscheiden. „Working out arrangements“, also die initiale Festlegung der Modalitäten einer Zusammenarbeit, ist immer „planned“, da es kein auslösendes Ereignis im (noch nicht ausgeführten) Arbeitsablauf geben kann. „Reworking arrangements“ ist in immer „situated“, da es immer aufgrund einer im Arbeitsprozess auftretenden problematischen Situation ausgelöst wird, die die Durchführung der bis dahin geltenden Modalitäten der Zusammenarbeit unmöglich macht. „Working out arrangements“ ist also ein Spezialfall von „planned explicit Articulation Work“, während „reworking arrangements“ ein Spezialfall von „situated explicit Articulation Work ist“.
...
Zusammenfassend können also drei Arten von „Articulation Work“ unterschieden werden:
\begin{itemize}
...
Das vorgeschlagene Prozess-Modell von „Articulation Work“ bildet den Ablauf auf so abstrakter Ebene ab, dass es für „situated explicit Articulation Work“ zur Lösung unmittelbar auftretender Probleme allgemein (d.h. unabhängig von der Anwendungsdomäne) anwendbar erscheint und auch in mit den von \cite{Corbin93} genannten Schritten bei der Durchführung expliziter Articulation Work in Einklang gebracht werden kann.
...
\begin{tabular}{| p{3cm} | p{10cm} |}
  ...
  Art von AW & planned und situated explizit (Workflow Planung und Unterstützung), situated implizit (Information Sharing)\\ \hline
...
\citep{Grinter96} führt in dieser Arbeit die Ideen von \citep{Bendifallah87} und \citep{Schmidt92} weiter und zeigt, wie die Softwareentwicklung als kooperativer Prozess durch computerbasierte Werkzeuge unterstützt werden kann.
...
\citeauthor{Grinter96} beschäftigt sich mit zwei Arten von Aufgaben, die im Rahmen eines Software-Entwicklungs-Prozesses im Rahmen von „Articulation Work“ zu bewältigen sind. Einerseits ist die tägliche Arbeit abzustimmen, so dass sichergestellt ist, dass die gerade erstellte Software korrekt funktioniert. Andererseits muss sichergestellt werden, dass auch das gesamte Produkt als Einheit funktioniert. Während die erstere Herausforderung durch das in den Fallstudien eingesetzte Configuration Management System unterstützt wurde (im Rahmen von „situated Articulation Work“, die sowohl implizit als auch explizit war), waren im zweiten Fall organisationale Maßnahmen wie die Bildung von Koordinations-Kommitees (also „planned explicit Articulation Work“) notwendig. 

\subsubsection{Unterstützung}

In der Arbeit detailliert beschrieben sind die Eigenschaften und Auswirkungen des Configuration Management Systems, so dass hier nur auf die Unterstützung von „situated Articulation Work“ eingegangen werden kann. Konkret muss hier weiter auf jene Fälle von „situated Articulation Work“ eingeschränkt werden, die von Problemen in Arbeitsabläufen ausgelöst werden, die auf konfliktionierende (Teil-)Ergebnisse der produktiven Arbeit zurückzuführen sind (hier: simultan editierter Source-Code, der nicht automatisiert zusammengeführt werden kann)
...
Die Arbeit von \citep{Grinter96} geht auf einen Spezialfall von „situated Articulation Work“ ein und zeigt, welche Unterstützungsleistung ein Software-Werkzeug bei der Ausgestaltung eines Arbeitsprozesses leisten kann, in dem sich die produktive Arbeit stark an Artefakten (hier: Source-Code) materialisiert. In derartigen Arbeits-Umgebungen erscheinen die vorgeschlagenen bzw. beschriebenen technischen Maßnahmen sinnvoll und führten in den angeführten Fällen offenbar zum Erfolg.
\\[1em]
\begin{tabular}{| p{3cm} | p{10cm} |}
  \hline
  Domäne & Software Entwicklung \\ \hline
  Art von AW & situated implizit und explizit (zur Vermeidung bzw. zur Beseitigung von konfliktionierenden Arbeitsergebnissen) \\ \hline
  Unterstützung & \emph{situated implizit}: Visualisierung aktuell durch andere Personen bearbeitete bzw. verwendete Arbeitsgegenstände; \emph{situated explizit}: adäquate Darstellung der konfliktionierenden Ergebnisse (Darstellung domänenabhängig) \\ \hline
...
\begin{description}
	...
	\item[\citet{Corbin93}] beschäftigen sich mit der Festlegung von Interaktionsmodalitäten in kooperativer Arbeit durch „Articulation Work“ und detaillieren dabei das Verständnis von expliziter „Articulation Work“, indem sie mögliche Zeitpunkte des Auftretens sowie Schritte bei deren Durchführung nennen.
	\item[\citet{Strauss93}] fasst im Rahmen einer umfassenderen Arbeit zur Entwicklung einer „Theory of Action“ seine Überlegungen zur Rolle und Ausgestaltung von „Articulation Work“ zusammen und würdigt diese kritisch. Konkrete Maßnahmen zur Unterstützung oder Ermöglichung von Articulation Work sind aber auch hier nicht vorhanden.
	\item[\citet{Schmidt94}] rephrasiert im Wesentlichen \citep{Schmidt90} mit Fokus auf den Aspekt der kooperativen Arbeit (und nicht der Computerunterstützung derselben). Er detailliert darin die Artikulationsnotwendigkeiten bei kooperativer Arbeit, führt jedoch hinsichtlich der Unterstützung von Articulation Work keine zusätzlichen Anforderungen ein.
	\item[\citet{Grinter95}] beschreibt die Verwendung von Konfigurations-Management-Systemen zur Koordination von Softwareentwicklungs-Prozessen. Sie bezieht sich dabei am Rand auf „Articulation Work“ (via \citep{Schmidt92}), führt diesen Aspekt aber nicht näher aus. Diese Arbeit bildet jedoch die Grundlage für die hinsichtlich der Unterstützung von „Articulation Work“ relevantere Arbeit derselben Autorin \citep{Grinter96}.
\end{description}

In folgenden Arbeiten wird „Articulation Work“ lediglich erwähnt, jedoch nicht näher darauf Bezug genommen:
\begin{description}
	\item[\citet{Lenoir94}] erwähnt „Articulation Work“ (konkret die Arbeit von \citet{Fujimura87}) als Beispiel der Verknüpfung unterschiedlicher wissenschaftlicher Arbeitskontexte, geht aber dann nicht näher auf „Articulation Work“ ein
\end{description}
