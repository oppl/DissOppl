...
Für die Untersuchung des Unterschiedes zwischen den beiden Interpretationsarten wurde der Wilcoxon-Test herangezogen. Dies war notwendig, da der Shapiro-Wilk-Test auf Normalverteilung zwar die Annahme der Normalverteilung als Voraussetzung für die Durchführung eines t-Tests bestätigte ($n_{Ergebnis}=21, p_{Ergebnis}=0.012, n_{Historie}=21, p_{Historie}<0.005$), der F-Test aber die Gleichheit der Varianzen der beiden Stichproben nicht bestätigen konnte ($n=21, p=0.078$).
