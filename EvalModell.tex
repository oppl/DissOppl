...
Im zweiten Teil der Untersuchung zu dieser Hypothese wurde 

Aussagen unterscheiden nach Personen mit Modellierungsvorkenntnissen und ohne. Häufig bei Leuten mit Prozessmodellierungshintergrund: zu wenig Elemente (Konnektoren). Einmalig: bitte mehr unterschiedliche Verbinderfarben zur Bedeutungscodierung.

\subsubsection{Diskussion} % (fold)

In Blöcken 3 und 5 sind 3 Kategorien von Elementen durch die Aufgabenstellung vorgegeben. In eher Ablauforientierten Aufgabenstellungen (2 und tw. 4) sind für Pers. mit Prozessmodellierunghintergrund tendentiell zuwenig Elementtypen vorhanden, Leute ohne Modellierungskenntnisse haben keine Probleme.
